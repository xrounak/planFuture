    ...
    <div className="space-y-10">
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-end border-b border-carbon-100 dark:border-white/5 pb-8 gap-6">
        <div>
          ...
          <h1 className="text-2xl sm:text-4xl font-black tracking-tighter text-black dark:text-white italic uppercase leading-none">Post-Score</h1>
          <p className="text-md sm:text-lg text-carbon-500 font-medium mt-3 uppercase tracking-tight">Evaluate daily output</p>
        </div>
      </header>
